...
{	
	...
	*/
	...
	private final byte suit;	//The suit of this card, one of the constants: SPADES, HEARTS, DIAMONDS, CLUBS. Immutable.     
	private final byte value; 	//The value of this card, from 1 to 13. Immutable.
	...
	Card(byte value, byte suit, boolean flip)
	{
		...
		this.value = value;
		this.suit = suit;
		flippedUp = flip; // Cards are flipped down by default
		setImage();
	}
